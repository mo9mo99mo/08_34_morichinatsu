...
// データ取得SQL作成
//ユーザー情報と投稿内容を紐付
$sql = "SELECT user.id, user.username, post.title, post.honbun, post.hizuke, post.img_file FROM users_table AS user INNER JOIN posts_table AS post ON user.id = post.user_id WHERE post.user_id = '$user_id'";
